...
def main():
	...
	batches_output = jpg_folder+'/photogrammetrist_batches_with_metadata'
...
#python create_photogrammetrist_batches_with_metadata.py --jpg_folder /Volumes/OTHER/Input_Photos/1_original_jpgs --n_batches 10  --participant_lookup_csv '/Users/sarah/Documents/GitHub/berkeley/forensic-estimation/XX Data/gopro_participant_lookup.csv'
